...
//     })
    ...
    function validateEmail(emailVal, emailError,email) {
        ...
        else if (a == -1 || b == -1 || +1 == b || emailVal.length - 1 == b) {
    ...
    function formSubmit(){
        ...
        inputval.innerHTML="Name:" + username  +", password:" + password+" ,country:" + country+" ,gender:" + gender+" ,hobby:"+checkedReligion.toString()
        console.log("country",country)
    }
    }